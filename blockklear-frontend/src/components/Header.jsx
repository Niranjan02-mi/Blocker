...
const Header = () => {
  ...
  const handleSwitchNetwork = async () => {
    const success = await switchToPolygonTestnet()
    if (success) {
              ...
              <div className="flex items-center space-x-3">
                ...
                {!isCorrectNetwork() && (
                  <button
                    ...
                    title="Switch to Polygon Mumbai"
                  >
                    Switch Network
                  </button>
                )}
          ...
          <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-2 text-yellow-700">
              ...
              <span className="text-sm">
                You're connected to {getNetworkName()}. Please switch to Polygon Mumbai for full functionality.
              </span>
            </div>
